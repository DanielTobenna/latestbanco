	...
	function qp_mailbox_list(){
		...
		if($(placeholder).length){
			...
			$(".email-delete").on("click", function(e){
				...
				var messageDelete = '<div class="alert alert-success alert-dismissable" style="opacity:0;"><button aria-hidden="true" data-dismiss="alert" class="close" type="button">Ã—</button>' + messageDeleteText + '</div>';
			...
			$(".email-mark-junk").on("click", function(e){
				...
				var messageJunk = '<div class="alert alert-success alert-dismissable" style="opacity:0;"><button aria-hidden="true" data-dismiss="alert" class="close" type="button">Ã—</button>' + messageJunkText + '</div>';
		...
		if(placeholder.length){
			...
			$("#send-email").on("click", function(e){
				...
				if(emailsMainObj == ""){
					...
					var errorMessage = '<div class="alert alert-danger alert-dismissable text-left" style="display:none;"><button aria-hidden="true" data-dismiss="alert" class="close" type="button">Ã—</button><strong>ERROR (DEMO ONLY)</strong><br /><br />The "To" field cannot be empty</div>';
					...
					var errorMessage = '<div class="alert alert-danger alert-dismissable text-left" style="display:none;"><button aria-hidden="true" data-dismiss="alert" class="close" type="button">Ã—</button><strong>ERROR (DEMO ONLY)</strong><br /><br />The "Subject" field cannot be empty</div>';
					...
					var successMessage = '<div class="alert alert-success alert-dismissable text-left" style="display:none;"><button aria-hidden="true" data-dismiss="alert" class="close" type="button">Ã—</button><strong>MESSAGE SENT (DEMO ONLY)</strong><br /><br />' + emailsMainRecepient + emailsCcText + emailsBccText + '</div>';
